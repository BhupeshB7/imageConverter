...
const PNGJPG = () => {
  ...
  return (
    <>
     <h1 className="m-2 mt-5 text-xl md:text-2xl text-center text-amber-100"> free online PNG to JPG Converter</h1>       
      <section className="flex flex-col items-center justify-center m-auto w-[80%] md:w-[70%] lg:w-[65%] space-y-4 rounded-lg p-4 mt-4 bg-[#2f3028]">
        <Helmet>
          <title>Convert PNG to JPG | Simple Image Converter</title>
          <meta
            name="description"
            content="Convert your PNG images to JPG format easily with our tool. Fast and user-friendly."
          />
          <meta
            name="keywords"
            content="PNG to JPG, image converter, convert PNG to JPG, online image converter"
          />
          <meta
            property="og:title"
            content="Convert PNG to JPG | Simple Image Converter"
          />
          <meta
